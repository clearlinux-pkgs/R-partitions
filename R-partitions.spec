...
Version  : 1.10.2
Release  : 23
URL      : https://cran.r-project.org/src/contrib/partitions_1.10-2.tar.gz
Source0  : https://cran.r-project.org/src/contrib/partitions_1.10-2.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1614098031
...
/usr/lib64/R/library/partitions/restrictedpartitionsgeneratingfunction.Rmd
